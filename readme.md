...
🙏본 프로젝트는 risuAi의 **장기기억(Long-Term Memory)** 관리 방식을 제미나이 2.5로 긴빠이쳐와서 파이썬 백엔드 라이브러리로 구현해 본 프로젝트입니다. 🙏[RisuAI](https://github.com/kwaroran/RisuAI) 개발팀에게 감사를 표하며, 이 프로젝트는 복잡한 대화내역 알아서 요약시키고 효율적으로 저장시키고 벡터로 저장, 요약, 검색하여 AI의 맥락 이해 능력과 일관성을 향상시키는 데 목적이 있습니다. 
